...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "premium-surface premium-ring soft-shimmer rounded-[28px] border border-white/10 bg-slate-900/50 backdrop-blur-2xl shadow-[0_22px_80px_rgba(2,8,23,0.42)]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "display-font text-2xl font-bold leading-none tracking-tight text-white md:text-[1.7rem]",
      className
    )}
    {...props}
  />
